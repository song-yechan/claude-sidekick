  ...
  return <div className="min-h-screen bg-background">
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  ...
                  <Input id="category-name" placeholder="예: 소설, 에세이, 자기계발..." value={newCategoryName} onChange={e => setNewCategoryName(e.target.value)} onKeyDown={e => {
                  if (e.key === 'Enter') {
                    handleAddCategory();
                  }
                }} maxLength={50} />
      ...
      <div className="p-4 space-y-3">
        {categories.length === 0 ? <Card>
            <CardContent className="p-8 text-center">
          ...
          </Card> : categories.map(category => <Card key={category.id} className="cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => navigate(`/categories/${category.id}`)}>
              ...
              backgroundColor: `${category.color}20`
                ...
                if (!open) setEditingCategory(null);
                      ...
                      <DialogTrigger asChild>
                        <Button variant="ghost" size="icon" onClick={() => setEditingCategory({
                    id: category.id,
                    name: category.name
                  })}>
                      ...
                      <DialogContent>
                        ...
                        <div className="space-y-4 py-4">
                          <div className="space-y-2">
                            ...
                            <Input id="edit-category-name" value={editingCategory?.name || ""} onChange={e => setEditingCategory(editingCategory ? {
                        ...editingCategory,
                        name: e.target.value
                      } : null)} onKeyDown={e => {
                        if (e.key === 'Enter') {
